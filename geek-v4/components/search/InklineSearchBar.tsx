...
// ★ 2026-06-13: 旧 '作品・コミュニティ・タグを検索' は focus 時に右の「キャンセル」
//   ボタンと衝突して末尾「索」が clip されていた (実測: 390pt 画面で input 幅
//   ≒222pt に対し 15 字 × ~16pt ≈ 240pt → 約18pt はみ出し)。重要度が低い
//   '作品・' を落として 12 字に短縮。SearchFocusOverlay の空状態文言
//   '作品・コミュニティ・タグを検索して…' は input ではないので維持。
const PLACEHOLDER = 'コミュニティ・タグを検索';
