...
import { PostsTab } from '../../../components/admin/userDetail/PostsTab';
import { ConcernsTab } from '../../../components/admin/userDetail/ConcernsTab';
import { ModerationTab } from '../../../components/admin/userDetail/ModerationTab';
...
// actionMeta は ModerationTab.tsx に移動 (Phase 8 split)
...
// PostsTab / ConcernsTab → components/admin/userDetail/{PostsTab,ConcernsTab}.tsx (Phase 8 split)

// ModerationTab → components/admin/userDetail/ModerationTab.tsx (Phase 8 split)
// EmptyState (local UserDetailEmptyState) → components/admin/userDetail/_shared.tsx
