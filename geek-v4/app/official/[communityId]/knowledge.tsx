// ============================================================
// geek-official — ナレッジ管理 (Q&A documents)
// ============================================================
// `app/(tabs)/community/[id]/qna-admin.tsx` のロジックを communityId
// (URL param 名違い) で動かす版。
// ============================================================
...
export default function OfficialKnowledgeScreen() {
      ...
      >
        {isLoading ? (
          ...
          <EmptyState
            icon={Icon.info}
            title="まだナレッジがありません"
            message="質問された時にここから引用される情報を追加しましょう"
            actionLabel="+ ナレッジを追加"
