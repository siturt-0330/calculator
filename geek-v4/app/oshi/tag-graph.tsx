...
import { NodeView } from '../../components/tag-graph/NodeView';
...
import { useTagGraphStore, TEMPLATES } from '../../stores/tagGraphStore';
...
// 抽出済み sub-component (Phase 8 split):
//   - StatBadge → components/ui/StatBadge.tsx
//   - NodeView  → components/tag-graph/NodeView.tsx
