// ============================================================
// communities/discover.ts — 検索 / discover (探す) 系
// ============================================================
// searchByName: 作成時の重複防止用 (近重複を返す)
// fetchOfficialCommunities: 探す画面の上部
// discoverCommunities: 旧 API (互換性のため searchCommunities をラップ)
// searchCommunities: マッチ理由 + スコア付きの高機能版
// ============================================================
import { supabase } from '../../supabase';
import { findSimilar } from '../../search/similarity';
import { generateVariants } from '../../search/variants';
import { escapeForIlike } from './_helpers';
